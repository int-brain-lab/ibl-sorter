...
### Added
- Expose destriping parameters (`butter_kwargs`, `k_filter`, `k_kwargs`) in `KilosortParams` and the YAML configuration file, forwarded to `ibldsp.voltage.decompress_destripe_cbin`
...
## 1.5
### 1.5.1 bugfix
- `probes.channel_labels` was referenced in plural in some paNorts of the code
### 1.5.0
